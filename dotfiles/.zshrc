...
export FZF_CTRL_T_COMMAND="command find -L . -mindepth 1 \\( -path '*/\\.*' \
	...
	-o -iname cplex \
	-o -iname idea-IC-203.6682.168 \
	-o -iname algo2_entregas \
	-o -iname algo1_entregas \
	-o -iname android-studio \
	-o -iname android-studio-sdk \
	-o -fstype 'sysfs' -o -fstype 'devfs' -o -fstype 'devtmpfs' -o -fstype 'proc' \\) -prune \
    -o -type f -print \
    -o -type d -print \
    -o -type l -print 2> /dev/null | cut -b3-"

export FZF_ALT_C_COMMAND="command find -L . -mindepth 1 \\( -path '*/\\.*' -o -fstype 'sysfs' \
	-o -iname anaconda3 \
	-o -iname venv \
	-o -iname node_modules \
	-o -iname cplex \
